...
const SignInPage = () => {
  ...
  // Animation Variants (non-intrusive, only for motion components)
  const fadeInUp = {
      ...
      >
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-r from-green-500 to-emerald-600 p-8 text-center"
          >
            <h1 className="text-3xl font-bold text-white mb-2">
              {isSignUp ? 'Create Account' : 'Welcome Back'}
            </h1>
            <p className="text-green-100">
              {isSignUp ? 'Join Basobaas today' : 'Sign in to your Basobaas account'}
            </p>
          </motion.div>
              ...
              {!isSignUp && !signInSuccess && (
                ...
                >
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                          signInErrors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-green-500'
                        }`}
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-10 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                          signInErrors.password ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-green-500'
                        }`}
                  ...
                  <motion.button
                    ...
                    className="w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition-colors font-medium disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                  ...
                  <motion.div variants={fadeInUp}>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                          signUpErrors.name ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-green-500'
                        }`}
                  ...
                  <motion.div variants={fadeInUp}>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleSignUpChange}
                        className={`w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                          signUpErrors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-green-500'
                        }`}
                        placeholder="Enter your email"
                      />
                    </div>
                  ...
                  <motion.div variants={fadeInUp}>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleSignUpChange}
                        className={`w-full pl-10 pr-10 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                          signUpErrors.password ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-green-500'
                        }`}
                  ...
                  <motion.div variants={fadeInUp}>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleSignUpChange}
                        className={`w-full pl-10 pr-10 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                          signUpErrors.confirmPassword ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-green-500'
                        }`}

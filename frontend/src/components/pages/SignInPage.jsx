...
const SignInPage = () => {
  ...
  const handleSignInSubmit = async (e) => {
    ...
    try {
      const result = await signIn(signInData.email, signInData.password, signInData.rememberMe);
      ...
      if (result.success) {
        ...
        setSignInErrors({ general: result.error });
      }
    } catch (error) {
      setSignInErrors({ general: 'An unexpected error occurred' });
    } finally {
  ...
  const handleSignUpSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setSignUpErrors({ general: result.error });
      }
    } catch (error) {
      setSignUpErrors({ general: 'An unexpected error occurred' });
    } finally {
